...
int main(int argc, char** argv) {
  ...
  EXPECT(checksum_write_value(index.entries[0].checksums[0]) == "19b162f03f28273c383e5b834ec037518d751a05");
  ...
  EXPECT(checksum_write_value(index.entries[1].checksums[0])  == "6c597dc1a66434091d7aef13c0294998c506501d");
  EXPECT(index.entries[1].checksums[1].type == ChecksumType::MD5);
  EXPECT(checksum_write_value(index.entries[1].checksums[1]) == "d58a0606ed616820de291d594602665d");
  ...
  EXPECT(checksum_write_value(index.entries[2].checksums[0]) == "3ba9914955fd6025641300592b56a74b");
  ...
  EXPECT(checksum_write_value(index.entries[3].checksums[0]) == "321060ae067e2a25091be3372719e053");
